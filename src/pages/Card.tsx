...
import { cardEmpty } from "../assets/img";
import { Link } from "react-router-dom";

const Cart = () => {
  const { cart, addToCart, removeFromCart, clearCart } = useCard();
    ...
    <div className="">
      {cart.length !== 0 ? (
        ...
        <div className="my-[80px] flex flex-col items-center">
          <img src={cardEmpty} alt="card" />
          <h2 className="text-blue-dark ledaing-[52px] mb-[24px] max-md:text-[33px] max-sm:text-[24px] text-[44px] font-bold font-josefin">
            Your cart is empty
          </h2>
          <Link to="/products">
